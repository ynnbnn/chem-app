...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState("test@chemcomply.app");
  ...
  async function handleDevLogin(e: React.FormEvent) {
    ...
    if (result?.ok) {
      ...
      setError("Login fehlgeschlagen. Versuchen Sie es erneut.");
    }
    setLoading(false);
  }
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-[var(--background)]">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Melden Sie sich an, um Ihre Pflanzenschutz-Dokumentation zu verwalten.
          </CardDescription>
        </CardHeader>
